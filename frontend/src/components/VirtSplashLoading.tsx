    ...
    <div className="text-center">
      ...
      <div className="relative w-32 h-32 mx-auto mb-6">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-3/4 h-3/4 bg-cyan-500/[0.08] rounded-full blur-[40px] animate-pulse" style={{ animationDuration: '3s' }} />
        </div>
        {/* 수면 파도 */}
        ...
        <img
          ...
          style={{
            filter: 'brightness(1.7) saturate(1.3) hue-rotate(-5deg) drop-shadow(0 0 14px rgba(91,157,255,0.55))',
          }}
        />
      </div>
      {/* 텍스트 */}
