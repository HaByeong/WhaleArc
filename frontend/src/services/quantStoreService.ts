...
export const US_ETF_NAMES: Record<string, string> = {
  ...
  'GLD':  'SPDR 골드 쉐어',
  'SLV':  'iShares 실버 트러스트',
  'USO':  'United States 원유 펀드',
  'XLK':  'Technology Select Sector',
  'XLF':  'Financial Select Sector',
  'XLE':  'Energy Select Sector',
  'XLV':  'Health Care Select Sector',
  'QLD':  'ProShares 2x 나스닥100',
  'SOXL': 'Direxion 3x 반도체 불',
  'NVDL': 'GraniteShares 2x 엔비디아',
  'TQQQ': 'ProShares 3x 나스닥100',
  'TSLL': 'Direxion 2x 테슬라',
  'SPXL': 'Direxion 3x S&P 500',
  'SQQQ': 'ProShares -3x 나스닥100',
  'TLT':  'iShares 20년+ 미국채',
  'AGG':  'iShares 미국 종합채권',
  'JEPI': 'JPMorgan S&P 인컴',
  'JEPQ': 'JPMorgan 나스닥 인컴',
  'ARKK': 'ARK 이노베이션',
  'IBIT': 'iShares 비트코인 신탁',
  'EEM':  'iShares 신흥국 MSCI',
  'EWY':  'iShares 한국 MSCI',
  'VNQ':  'Vanguard 미국 부동산',
};
