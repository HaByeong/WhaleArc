              ...
              <div className="flex items-center gap-2">
                ...
                {s.isUser && (
                  <span className="flex shrink-0 items-center gap-0.5">
                    <button type="button" title="수정" onClick={(e) => { e.stopPropagation(); onEditUser(s.id); }} className="flex h-6 w-6 items-center justify-center rounded-md hover:bg-white/10" style={{ color: INK2 }}>
                    ...
                    <button type="button" title="삭제" onClick={(e) => { e.stopPropagation(); onDeleteUser(s.id); }} className="flex h-6 w-6 items-center justify-center rounded-md hover:bg-white/10" style={{ color: INK2 }}>
